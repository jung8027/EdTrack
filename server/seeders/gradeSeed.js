...
const gradeSeedFunc = () => {
	...
	//add the following Grades to the database:
		.then(() => models.Grade.bulkCreate([
			...
			{grade: 65, type: 'quiz', 			StudentId: 1},
			{grade: 75, type: 'quiz', 			StudentId: 1},
			{grade: 80, type: 'quiz', 			StudentId: 1},
			{grade: 60, type: 'quiz', 			StudentId: 1},
			...
			{grade: 80, type: 'quiz', 			StudentId: 2},
			{grade: 85, type: 'quiz', 			StudentId: 2},
			{grade: 100, type: 'quiz', 			StudentId: 2},
			{grade: 100, type: 'quiz', 			StudentId: 2},
			...
			{grade: 60, type: 'quiz', 			StudentId: 3},
			{grade: 65, type: 'quiz', 			StudentId: 3},
			{grade: 60, type: 'quiz', 			StudentId: 3},
			{grade: 70, type: 'quiz', 			StudentId: 3},
			...
			{grade: 75, type: 'quiz', 			StudentId: 4},
			{grade: 80, type: 'quiz', 			StudentId: 4},
			{grade: 100, type: 'quiz', 			StudentId: 4},
			...
			{grade: 75, type: 'quiz', 			StudentId: 5},
			{grade: 80, type: 'quiz', 			StudentId: 5},
			{grade: 75, type: 'quiz', 			StudentId: 5},
			{grade: 85, type: 'quiz', 			StudentId: 5},
			...
			{grade: 75, type: 'quiz', 			StudentId: 6},
			{grade: 80, type: 'quiz', 			StudentId: 6},
			{grade: 70, type: 'quiz', 			StudentId: 6},
			{grade: 70, type: 'quiz', 			StudentId: 6},
			{grade: 97, type: 'assignment', StudentId: 6},
			{grade: 80, type: 'midterm', 		StudentId: 6},
			{grade: 70, type: 'final', 			StudentId: 6},
			{grade: 55, type: 'quiz', 			StudentId: 7},
			{grade: 60, type: 'quiz', 			StudentId: 7},
			...
			{grade: 80, type: 'quiz', 			StudentId: 9},
			{grade: 85, type: 'quiz', 			StudentId: 9},
			{grade: 80, type: 'quiz', 			StudentId: 9},
			{grade: 90, type: 'quiz', 			StudentId: 9},
			...
			{grade: 80, type: 'quiz', 			StudentId: 10},
			{grade: 85, type: 'quiz', 			StudentId: 10},
			{grade: 90, type: 'quiz', 			StudentId: 10},
			{grade: 70, type: 'quiz', 			StudentId: 10},
